...
import { ApiProductListing } from "../../../api-wrapper/product/ApiProduct";
...
function Product() {
  ...
  const ApiCustomFilterHandler = async () => {
    if (customFilterFlag) {
      ...
      await ApiProductListing(data)
        .then((e) => {
          if (e?.isSuccess) {
            setTableData(e?.getProductAds);
          } else {
          }
  ...
  const columns = [
    {
      ...
      cell: (rows) => (
        <div className="action_container">
          {PermissionCheck("Product Ads", "Update") ? (
            <i
              className="fa fa-pencil"
              onClick={() => {
                setAddName(t("editAddProduct"))
                setEditData(rows);
                setShowAdGroup(true);
              }}
            ></i>
    ...
    <>
      ...
      <div className="middle_container">
        <div className="data_content data_content_btn">
          <div className="data_model_btn camapgin_btn">
            ...
            <div className="filTypeBox">
              ...
              <DateRangePicker
                ...
                cleanable={false}
              />
              {PermissionCheck("Product Ads", "Create") && (
                <div className="pb-1">
                  <button
                    onClick={() => {
                      setAddName(t("addProduct"));
                      setEditData({});
                      setShowAdGroup(true);
                      setaddFlag(true);
                    }}
          ...
          {PermissionCheck("Product Ads", "View Only") && (
